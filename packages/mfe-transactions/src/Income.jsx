...
import { Dashboard, useUser, axiosConfig, API_ENDPOINTS, getErrorMessage, Modal, DeleteAlert } from "@mm/shared";
...
const Income = () => {
    ...
    const handleUpdateIncome = async (income) => {
        ...
        if (!id) {
            toast.error("Income ID is missing for update");
            return;
        }
        ...
        try {
            const response = await axiosConfig.put(API_ENDPOINTS.UPDATE_INCOME(id), {
                name,
                amount: Number(amount),
                date,
                icon,
            ...
            <div className="my-5 mx-auto">
                <div className="grid grid-cols-1 gap-6">
                    ...
                    <Modal
                        ...
                        onClose={() => { setOpenEditIncomeModal(false); setSelectedIncome(null); }}
                        title="Update Income"
                    >
                        <AddIncomeForm
