...
const Menubar = ({ activeMenu }) => {
  ...
  return (
    <header
      className="flex items-center justify-between gap-5 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200/80 dark:border-gray-700/60 py-4 px-4 sm:px-7 sticky top-0 z-30 shadow-sm shadow-gray-200/50 dark:shadow-none transition-colors duration-300"
      role="banner"
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center justify-center w-11 h-11 rounded-2xl bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-800 dark:to-indigo-800 text-purple-700 dark:text-purple-300 hover:from-purple-200 hover:to-indigo-200 dark:hover:from-purple-700 dark:hover:to-indigo-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 overflow-hidden ring-2 ring-purple-200/50 dark:ring-purple-700/50"
            aria-haspopup="true"
          ...
          {showDropdown && (
            <div
              className="absolute right-0 mt-2 w-64 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200/80 dark:border-gray-700 py-2 z-50 animate-scale-in overflow-hidden"
              role="menu"
            >
      ...
      {openSideMenu && (
        <div
          className="fixed top-[65px] left-0 right-0 bg-white/98 dark:bg-gray-900/98 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 shadow-xl lg:hidden z-20 animate-fade-in"
          role="dialog"
        >
