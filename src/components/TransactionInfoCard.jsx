...
const TransactionInfoCard = ({
  ...
  return (
    <div className="group relative flex items-center gap-4 p-4 rounded-xl hover:bg-purple-50/50 dark:hover:bg-purple-900/10 transition-all duration-200 border border-transparent hover:border-purple-100 dark:hover:border-purple-800/40">
      <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 text-gray-600 dark:text-gray-400 group-hover:from-purple-50 group-hover:to-indigo-50 dark:group-hover:from-purple-900/30 dark:group-hover:to-indigo-900/30 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
        {icon ? (
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {!hideDeleteBtn && (
            <button
              type="button"
              onClick={onDelete}
              className="p-2 rounded-lg text-gray-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 opacity-0 group-hover:opacity-100 transition-all duration-200 cursor-pointer"
              aria-label="Delete"
            >
              <Trash2 size={18} />
            </button>
          ...
          >
            ...
            {isIncome ? (
              ...
              <TrendingDown size={16} className="text-rose-600 dark:text-rose-400" aria-hidden />
            )}
          </div>
        </div>
      </div>
